...
public class Texture {
  ...
  public void init(String filePath) {
    ...
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S,
        GL_REPEAT); //говорит о том, что нужно "растягивать" текстуру по x(S)
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T,
        GL_REPEAT); //говорит о том, что нужно "растягивать" текстуру по y(T)
    ...
    STBImage.stbi_image_free(image); //делает free для памяти, которую выделила библиотека stbi
  }
  ...
  public boolean equals(Object o) {
    ...
    var isTexture = o instanceof Texture;
    if (!isTexture) {
      return false;
    }
