...
public class RenderBatch implements Comparable<RenderBatch>
{
    ...
    public List<Texture> textures; // textures that are contained within this batch
    ...
    public void render()
    {
        ...
        shader.uploadMat4f("uProjection", MainCycle.getScene().camera().getProjectionMatrix());
        shader.uploadMat4f("uView", MainCycle.getScene().camera().getViewMatrix());
    ...
    private void loadVertexProperties(int index)
    {
        ...
        int texId = 0; //we don't have texture yet
        ...
        if(isRotated)
        {
            ...
            //TODO: здесь задаётся поворот объекта
